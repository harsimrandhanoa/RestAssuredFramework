...
public class LoginTest extends BaseTest {
	...
	public  void doLogin(Hashtable<String,String> data) {
	    ...
	    String expectedStatus = data.get("expectedstatus");
	  	...
	  	log("Logging into app using username :"+username+ " and  password: "+password+ " The expected login status is "+expectedStatus);
       ...
       sessionId = resp.getHeader("sessionId");
	    ...
	    if(expectedStatus.equals("Login failed")){
          ...
          if(!actualStatus.equals("failure")&&!errorMessage.equals("invalid username/password")){
  	    	reportFailure("Login should have failed with appropriate message but instead the message we are getting is  "+errorMessage +" and the login status is "+actualStatus, false);
	    	}
	    }
