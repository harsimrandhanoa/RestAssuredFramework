...
public class CategoryList {
	...
	public CategoryList() {
		...
		if (productMap == null) {
			...
			// System.out.println("As productMap is null so will create a new
			// one");
	...
	public void createNewList(String categoryName) {
		// System.out.println("In create new list class.adding key to
		// map"+categoryName+" and will also instantiate"
	...
	public Map<String, List<Product>> addProduct(Product p) {
		...
		// System.out.println("In addProduct method . Here we will add product p
		// to out list");
